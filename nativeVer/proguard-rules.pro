...
-keep class com.proxy.shadowsocksrn.impl.** { *; }
-keep class com.proxy.shadowsocksrn.util.** { *; }
-keep class com.proxy.shadowsocksrn.items.SSRProfile { *; }
-keep class com.proxy.shadowsocksrn.items.GlobalProfile { *; }
-keep class com.proxy.shadowsocksrn.preference.** { *; }
